    ...
    if(req.body.epost !== undefined) {
        ...
        if(validation.error) {
            ...
            mysqlpool.getConnection(function(error, connPool) {
                ...
                connPool.query(checkQueryFormat, (error, selResults) => {
                    if (error) {
                        connPool.release();
                    ...
                    if(selResults[0] !== undefined) {
                        ...
                        crypto.randomBytes(20, (err, buf) => {
                            ...
                            connPool.query(insertTokenQueryFormat, (error, insResults) => {
                                connPool.release();
                                if (error) {
            ...
            mysqlpool.getConnection(function(error, connPool) {
                ...
                connPool.query(checkQueryFormat, (error, results) => {
                    ...
                    if(results[0] !== undefined) {
                        ...
                        connPool.query(insertQueryFormat, (error, updResults) => {
                            if (error) {
                                connPool.release();
                            ...
                            if(updResults.affectedRows > 0) {
                                ...
                                connPool.query(deleteQueryFormat, (error, delGPResults) => {
                                    if (error) {
                                        connPool.release();
                                    ...
                                    if(delGPResults.affectedRows > 0) {
                                        ...
                                        connPool.query(deleteLoginQueryFormat, (error, delLResults) => {
                                            connPool.release();
                                            if (error) {
